...
class CiviliteController extends Controller
{
    ...
    {
        return $this->render('civilite/index.html.twig', ['civilites' => $civiliteRepository->findAll()]);
    }
    ...
    {
        return $this->render('civilite/show.html.twig', ['civilite' => $civilite]);
    }
    ...
    public function edit(Request $request, Civilite $civilite): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('civilite_edit', ['id' => $civilite->getId()]);
        }
